...
const { paymentRequestService, createRasxodDocService, getRasxodService, getByIdRasxodService, deeleteRasxodService, updateRasxodService } = require('./rasxod.service')
