...
exports.OrganizationDB = class {
    static async createAccountNumber(params, values, client) {
        const query = `
            INSERT INTO organ_account_numbers(
                account_number,
                organ_id
            ) 
            VALUES ${values}
...
exports.organizationCreateService = async (data) => {
    try {
...
exports.organizationUpdateService = async (data) => {
    try {
...
exports.getorganizationService = async (user_id, search, offset, limit) => {
    try {
        let filter = ``;
...
exports.excelDataOrganizationService = async (user_id) => {
    try {
        const { rows } = await pool.query(`
            WITH data AS (
...
exports.getByIdorganizationService = async (user_id, id, isdeleted = false, lang) => {
    try {
        let filter = ``
        if (!isdeleted) {
...
exports.getByStrOrganizationService = async (str, user_id, lang) => {
    try {
