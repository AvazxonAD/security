...
var Joi = require("joi");
var deductionValidation = Joi.object({
  name: Joi.string().trim().required(),
  percent: Joi.number().required().min(1).max(99)
});
var prixodRasxodQueryValidation = Joi.object({
...
var adminPrixodRasxodQueryValidation = Joi.object({
  page: Joi.number().min(1)["default"](1),
  limit: Joi.number().min(1)["default"](10),
  to: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  from: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
...
var monitoringQueryValidation = Joi.object({
...
var adminMonitoringQueryValidation = Joi.object({
  year: Joi.string().trim().pattern(/^(20\d{2}|[2-9]\d{3})$/).required(),
  month: Joi.string().trim().pattern(/^(0[1-9]|1[0-2])$/).required(),
  user_id: Joi.number().min(1)
});
var rasxodValidation = Joi.object({
...
var rasxodFioValidation = Joi.object({
  ...
  to: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  from: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  worker_tasks: Joi.array().items(Joi.object({
...
var paymentRequestValidation = Joi.object({
  account_number_id: Joi.number().required().min(1),
  batalon_id: Joi.number().required().min(1),
  to: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  from: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required()
...
var batalionValidation = Joi.object({
  name: Joi.string().trim().required(),
  birgada: Joi["boolean"](),
  ...
  gazna_numbers: Joi.array().items(Joi.object({
...
var bxmValidation = Joi.object({
  summa: Joi.number().required().min(1)
});
var getByIdBxmSchema = Joi.object({
  params: Joi.object({
...
var allQueryValidation = Joi.object({
  page: Joi.number().min(1)["default"](1),
  limit: Joi.number().min(1)["default"](10),
  search: Joi.string()
});
var workerQueryValidation = Joi.object({
  page: Joi.number().min(1)["default"](1),
  limit: Joi.number().min(1)["default"](10),
  search: Joi.string().trim(),
  batalon_id: Joi.number().min(1)
});
var contractValidation = Joi.object({
...
var contractUpdateValidation = Joi.object({
  doc_num: Joi.string().trim().required().pattern(/^\d+(\.\d+)?$/),
  doc_date: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  period: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  adress: Joi.string().trim().required(),
...
var prixodExcelValidation = Joi.object({
...
var prixodValidation = Joi.object({
...
var workerTaskValidation = Joi.object({
  workers: Joi.array().items(Joi.object({
    task_time: Joi.number().min(0.1).required(),
    worker_id: Joi.number().integer().required()
  }).required())
});
var workerTaskUpdateValidation = Joi.object({
  task_time: Joi.number().min(0.1).required(),
  worker_id: Joi.number().integer().required()
});
var conrtactQueryValidation = Joi.object({
  page: Joi.number().min(1)["default"](1),
  limit: Joi.number().min(1)["default"](10),
  search: Joi.string().trim(),
  from: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
...
var rasxodQueryValidation = Joi.object({
  page: Joi.number().min(1)["default"](1),
  limit: Joi.number().min(1)["default"](10),
  from: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
  to: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
...
var workerExcelValidation = Joi.object({
  FIO: Joi.string().trim().required(),
...
var prixodQueryValidation = Joi.object({
  page: Joi.number().min(1)["default"](1),
  limit: Joi.number().min(1)["default"](10),
  search: Joi.string().trim(),
  from: Joi.string().trim().pattern(/^(19|20)\d{2}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/).required(),
...
var contractTemplateValidation = Joi.object({
...
module.exports = {
  ...
  batalionValidation: batalionValidation,
  bxmValidation: bxmValidation,
  accountNumberValidation: accountNumberValidation,
  doerValidation: doerValidation,
  bossValidation: bossValidation,
  adressValidation: adressValidation,
  ...
  allQueryValidation: allQueryValidation,
  workerQueryValidation: workerQueryValidation,
  contractValidation: contractValidation,
  prixodValidation: prixodValidation,
  workerTaskValidation: workerTaskValidation,
  workerTaskUpdateValidation: workerTaskUpdateValidation,
  conrtactQueryValidation: conrtactQueryValidation,
  workerExcelValidation: workerExcelValidation,
  prixodQueryValidation: prixodQueryValidation,
  contractTemplateValidation: contractTemplateValidation,
  paymentRequestValidation: paymentRequestValidation,
  rasxodValidation: rasxodValidation,
  rasxodQueryValidation: rasxodQueryValidation,
  rasxodFioValidation: rasxodFioValidation,
  deductionValidation: deductionValidation,
  prixodExcelValidation: prixodExcelValidation,
  prixodRasxodQueryValidation: prixodRasxodQueryValidation,
  monitoringQueryValidation: monitoringQueryValidation,
  userValidation: userValidation,
  adminPrixodRasxodQueryValidation: adminPrixodRasxodQueryValidation,
  adminMonitoringQueryValidation: adminMonitoringQueryValidation,
  contractUpdateValidation: contractUpdateValidation,
  getByIdBxmSchema: getByIdBxmSchema
};