...
var getByIdTaskService = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(user_id, task_id) {
    var ignore_isdeleted,
      batalon,
      lang,
      batalon_filter,
      condition,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          return _context.abrupt("return", task.rows[0]);
        case 16:
          _context.prev = 16;
  ...
  return function getByIdTaskService(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var getByContractIdTaskService = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(conrtact_id) {
    var tasks;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          return _context2.abrupt("return", tasks.rows);
        case 7:
          _context2.prev = 7;
  ...
  return function getByContractIdTaskService(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
var getTaskService = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(user_id, batalon_id, birgada) {
    var params, batalon_filter, birgada_filter, data;
  ...
  return function getTaskService(_x4, _x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
module.exports = {
  getByIdTaskService: getByIdTaskService,
  getByContractIdTaskService: getByContractIdTaskService,
