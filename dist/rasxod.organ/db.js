...
var _require = require('../db/index'),
  db = _require.db;
exports.RasxodOrganDB = /*#__PURE__*/function () {
  function _class() {
  ...
  return _createClass(_class, null, [{
    ...
    key: "get",
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(params, search) {
            ...
            case 0:
              ...
              if (search) {
                ...
                if (!isNaN(search) && !IsNaN(parseFloat(search))) {
                  search_filter = "AND p.doc_num = $".concat(params.length);
                } else {
                  search_filter = "AND o.name ILIKE '%' || $".concat(params.length, " || '%'");
                }
              }
    ...
    key: "update",
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
        var query, result;
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(params) {
        var query, result;
