...
var _require2 = require('../spravochnik/account.number/service'),
  AccountNumberService = _require2.AccountNumberService;
var _require3 = require('./service'),
  RasxodOrganService = _require3.RasxodOrganService;
var _require4 = require('../helper/functions'),
  Functions = _require4.Functions;
  ...
  return _createClass(_class, null, [{
    ...
    value: function () {
      var _create = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
        var account_number_id, user_id, _req$body, organization_id, organ_account_number_id, gazna_number_id, organization, check, _check, account_number, result;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              account_number_id = req.query.account_number_id;
              user_id = req.user.id;
              _req$body = req.body, organization_id = _req$body.organization_id, organ_account_number_id = _req$body.organ_account_number_id, gazna_number_id = _req$body.gazna_number_id;
              _context.next = 5;
            ...
            case 18:
              ...
              return _context.abrupt("return", res.error(req.i18n.t('accountNumberError'), 404));
            case 21:
              _context.next = 23;
              return RasxodOrganService.create(_objectSpread(_objectSpread({}, req.body), {}, {
                user_id: user_id,
    ...
    value: function () {
      var _get = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        var _req$query, account_number_id, page, limit, search, from, to, user_id, account_number, offset, _yield$RasxodOrganSer, from_balance, to_balance, summa, total_count, data, pageCount, meta;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _req$query = req.query, account_number_id = _req$query.account_number_id, page = _req$query.page, limit = _req$query.limit, search = _req$query.search, from = _req$query.from, to = _req$query.to;
              user_id = req.user.id;
              _context2.next = 4;
              return AccountNumberService.getById({
                user_id: user_id,
            ...
            case 4:
              ...
              return _context2.abrupt("return", res.error(req.i18n.t('accountNumberError'), 404));
            case 7:
              offset = (page - 1) * limit;
              _context2.next = 10;
              return RasxodOrganService.get({
                limit: limit,
                search: search,
                from: from,
                to: to,
            ...
            case 10:
              _yield$RasxodOrganSer = _context2.sent;
              from_balance = _yield$RasxodOrganSer.from_balance;
              to_balance = _yield$RasxodOrganSer.to_balance;
              summa = _yield$RasxodOrganSer.summa;
              total_count = _yield$RasxodOrganSer.total_count;
              data = _yield$RasxodOrganSer.data;
              pageCount = Math.ceil(total_count);
              meta = {
                pageCount: pageCount,
                count: total_count,
                currentPage: page,
    ...
    value: function () {
      var _getById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        var user_id, id, account_number_id, result;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              account_number_id = req.query.account_number_id;
              _context3.next = 5;
              return RasxodOrganService.getById({
                id: id,
                user_id: user_id,
                account_number_id: account_number_id
              });
    ...
    value: function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        var account_number_id, user_id, id, _req$body2, organization_id, organ_account_number_id, gazna_number_id, oldData, organization, check, _check2, account_number, result;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              user_id = req.user.id;
              id = req.params.id;
              _req$body2 = req.body, organization_id = _req$body2.organization_id, organ_account_number_id = _req$body2.organ_account_number_id, gazna_number_id = _req$body2.gazna_number_id;
              _context4.next = 6;
              return RasxodOrganService.getById({
                user_id: user_id,
                id: id,
            ...
            case 24:
              ...
              return _context4.abrupt("return", res.error(req.i18n.t('accountNumberError'), 404));
            case 27:
              _context4.next = 29;
              return RasxodOrganService.update(_objectSpread(_objectSpread({}, req.body), {}, {
                user_id: user_id,
                account_number_id: account_number_id,
                id: id
              }));
    ...
    value: function () {
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        var user_id, id, account_number_id, data, result;
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 8:
              _context5.next = 10;
              return RasxodOrganService["delete"]({
                id: id
              });
            case 10:
