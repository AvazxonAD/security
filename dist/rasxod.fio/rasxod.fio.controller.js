...
var _require = require("../utils/validation"),
  ...
  rasxodFioValidation = _require.rasxodFioValidation,
...
var _require5 = require('./rasxod.fio.service'),
...
var _require8 = require('./rasxod.fio.service'),
  getByIdWorkerTaskService = _require8.getByIdWorkerTaskService;
var _require9 = require('../utils/return.summa'),
  returnStringSumma = _require9.returnStringSumma;
var _require10 = require('../spravochnik/deduction/deduction.service'),
  getByIddeductionService = _require10.getByIddeductionService;
...
var getPaymentRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var user_id, _validationResponse, account_number_id, batalon_id, to, from, data, summa, _iterator, _step, item, meta;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          _context.next = 7;
          return getByIdBatalonService(user_id, batalon_id, false, true, req.i18n);
        case 7:
          _context.next = 9;
...
var createRasxod = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var user_id, from, to, account_number_id, _req$body, batalon_account_number_id, batalon_gazna_number_id, _rasxodFioValidation$, error, data, batalon, check, _check, _iterator2, _step2, task, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _rasxodFioValidation$ = rasxodFioValidation.validate(_objectSpread(_objectSpread({}, req.body), {}, {
            from: from,
            to: to
          })), error = _rasxodFioValidation$.error, data = _rasxodFioValidation$.value;
          if (!error) {
            _context3.next = 9;
            break;
          }
          return _context3.abrupt("return", res.error(req.i18n.t('validationError'), 400));
        case 9:
          _context3.next = 11;
          return getByIdaccount_numberService(user_id, account_number_id, null, req.i18n);
        case 11:
          _context3.next = 13;
          return getByIdBatalonService(user_id, data.batalon_id, false, true, req.i18n);
        case 13:
          ...
          return _context3.abrupt("return", res.error(req.i18n.t('accountNumberNotFound'), 404));
        case 18:
          ...
          return _context3.abrupt("return", res.error(req.i18n.t('gaznaNumberNotFound'), 404));
        case 22:
          _context3.next = 24;
          return Promise.all(data.deductions.map(/*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(item) {
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return getByIddeductionService(user_id, item.deduction_id, null, req.i18n);
                  case 2:
                    deduction = _context2.sent;
                    return _context2.abrupt("return", deduction);
                  case 4:
                  case "end":
        ...
        case 24:
          data.deductions = _context3.sent;
          _iterator2 = _createForOfIteratorHelper(data.worker_tasks);
          _context3.prev = 26;
          _iterator2.s();
        case 28:
          ...
          task = _step2.value;
          _context3.next = 32;
          return getByIdWorkerTaskService(data.batalon_id, task.worker_task_id, user_id, req.i18n);
        case 32:
          _context3.next = 28;
          break;
        case 34:
    ...
    }, _callee3, null, [[0, 48], [26, 36, 39, 42]]);
  }));
...
var getRasxod = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var user_id, _validationResponse2, from, to, account_number_id, page, limit, batalon_id, offset, _yield$getRasxodServi, total, data, summa_from, summa_to, pageCount, meta;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 5:
          ...
          _context4.next = 8;
          return getByIdBatalonService(user_id, batalon_id, false, null, req.i18n);
        case 8:
          offset = (page - 1) * limit;
          _context4.next = 11;
          return getRasxodService(user_id, account_number_id, from, to, offset, limit, batalon_id);
        case 11:
          _yield$getRasxodServi = _context4.sent;
  ...
  return function getRasxod(_x6, _x7) {
...
var getByIdRasxod = /*#__PURE__*/function () {
  ...
  return function getByIdRasxod(_x8, _x9) {
...
var deeleteRasxod = /*#__PURE__*/function () {
  ...
  return function deeleteRasxod(_x10, _x11) {
...
var updateRasxod = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var user_id, account_number_id, id, from, to, oldData, _rasxodFioValidation$2, error, data, _iterator3, _step3, _loop, result;
    return _regeneratorRuntime().wrap(function _callee8$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          return getByIdRasxodService(user_id, account_number_id, id, null, req.i18n);
        case 8:
          oldData = _context9.sent;
          _rasxodFioValidation$2 = rasxodFioValidation.validate(_objectSpread(_objectSpread({}, req.body), {}, {
            from: from,
            to: to
          })), error = _rasxodFioValidation$2.error, data = _rasxodFioValidation$2.value;
          if (!error) {
            _context9.next = 12;
            break;
          }
          return _context9.abrupt("return", res.error(req.i18n.t('validationError'), 400));
        case 12:
          _context9.next = 14;
          return getByIdaccount_numberService(user_id, account_number_id, null, req.i18n);
        case 14:
          ...
          return getByIdBatalonService(user_id, data.batalon_id, false, true, req.i18n);
        case 16:
          _iterator3 = _createForOfIteratorHelper(data.worker_tasks);
          _context9.prev = 17;
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context8) {
              while (1) switch (_context8.prev = _context8.next) {
                case 0:
                  task = _step3.value;
                  test = oldData.worker_tasks.find(function (item) {
                  ...
                  _context8.next = 5;
                  return getByIdWorkerTaskService(data.batalon_id, task.task_id, user_id, req.i18n);
                case 5:
                case "end":
        ...
        case 20:
          ...
          return _context9.delegateYield(_loop(), "t0", 22);
        case 22:
          _context9.next = 20;
          break;
        case 24:
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    return getByIddeductionService(user_id, item.deduction_id, null, req.i18n);
                  case 2:
                    deduction = _context7.sent;
                    return _context7.abrupt("return", deduction);
                  case 4:
                  case "end":
        ...
        case 34:
          data.deductions = _context9.sent;
          _context9.next = 37;
...
var exportExcelData = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 10:
          _yield$getRasxodServi2 = _context10.sent;
          ...
          file_name = "rasxod_batalon_".concat(new Date().getTime(), ".xlsx");
        ...
        case 71:
          return _context10.abrupt("return", res.download(filePath, function (err) {
            if (err) {
  ...
  return function exportExcelData(_x15, _x16) {
    return _ref9.apply(this, arguments);
  };
}();
var exportRasxodByIdExcelData = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var user_id, account_number_id, id, data, workbook, file_name, worksheet, css_array, titleCell, row_number, deductionTitleCell, deductionNameCell, deductionPercentCell, fioCell, xisobRaqamCell, accountNumberCell, task_timeCell, summaCell, deductionCell, result_summaCell, itogo_summa, itogo_deduction, itogo_result, _iterator5, _step5, worker, _fioCell, _xisobRaqamCell, _accountNumberCell, _task_timeCell, _summaCell, _deductionCell, _result_summaCell, _css_array2, itogoStr, itogo_summaCell, itogo_deductionCell, itogo_resultCell, filePath;
    return _regeneratorRuntime().wrap(function _callee10$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 8:
          ...
          workbook = new ExcelJS.Workbook();
          file_name = "rasxod_fio_".concat(new Date().getTime(), ".xlsx");
          worksheet = workbook.addWorksheet("rasxod_docs");
          ...
          titleCell = worksheet.getCell("A1");
          titleCell.value = "".concat(returnStringDate(new Date(data.from)), "\u0434\u0430\u043D ").concat(returnStringDate(new Date(data.to)), "-\u0433\u0430\u0447\u0430 \u043E\u043C\u043C\u0430\u0432\u0438\u0439 \u0442\u0430\u0434\u0431\u0438\u0440\u043B\u0430\u0440\u0434\u0430 \u049B\u0430\u0442\u043D\u0430\u0448\u0433\u0430\u043D ").concat(data.batalon_name, " \u0431\u0430\u0442\u0430\u043B\u044C\u043E\u043D  \u0445\u043E\u0434\u0438\u043C\u043B\u0430\u0440\u0433\u0430 \u043F\u0443\u043B \u045E\u0442\u043A\u0430\u0437\u0438\u0448");
          css_array.push(titleCell);
          row_number = 2;
          if (data.deductions.length > 0) {
            worksheet.mergeCells("A".concat(row_number), "B".concat(row_number));
            deductionTitleCell = worksheet.getCell("A".concat(row_number));
            deductionTitleCell.value = "\u0423\u0448\u043B\u0430\u043D\u043C\u0430\u043B\u0430\u0440";
            css_array.push(deductionTitleCell);
            row_number++;
            deductionNameCell = worksheet.getCell("A".concat(row_number));
            deductionNameCell.value = "\u0423\u0448\u043B\u0430\u043D\u043C\u0430 \u043D\u043E\u043C\u0438";
            css_array.push(deductionNameCell);
            deductionPercentCell = worksheet.getCell("B".concat(row_number));
            deductionPercentCell.value = "\u0423\u0448\u043B\u0430\u043D\u043C\u0430 \u0444\u043E\u0438\u0437\u0438 %";
            css_array.push(deductionPercentCell);
            row_number++;
            data.deductions.forEach(function (item) {
              var deductionNameCell = worksheet.getCell("A".concat(row_number));
              deductionNameCell.value = item.deduction_name;
              css_array.push(deductionNameCell);
              var deductionPercentCell = worksheet.getCell("B".concat(row_number));
              deductionPercentCell.value = "".concat(item.percent, "%");
              css_array.push(deductionNameCell, deductionPercentCell);
              row_number++;
            });
          }
          fioCell = worksheet.getCell("A".concat(row_number));
          fioCell.value = 'ФИО';
          xisobRaqamCell = worksheet.getCell("B".concat(row_number));
          xisobRaqamCell.value = "\u0425\u0438\u0441\u043E\u0431 \u0440\u0430\u049B\u0430\u043C\u0438";
          accountNumberCell = worksheet.getCell("C".concat(row_number));
          accountNumberCell.value = "\u041A\u0430\u0440\u0442\u0430 \u0440\u0430\u049B\u0430\u043C\u0438";
          task_timeCell = worksheet.getCell("D".concat(row_number));
          task_timeCell.value = 'Вақт';
          summaCell = worksheet.getCell("E".concat(row_number));
          summaCell.value = "\u0421\u0443\u043C\u043C\u0430";
          deductionCell = worksheet.getCell("F".concat(row_number));
          deductionCell.value = 'Ушлаб қолинган';
          result_summaCell = worksheet.getCell("G".concat(row_number));
          ...
          itogo_result = 0;
          row_number++;
          _iterator5 = _createForOfIteratorHelper(data.worker_tasks);
          try {
            for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
              worker = _step5.value;
              _fioCell = worksheet.getCell("A".concat(row_number));
              _fioCell.value = worker.fio;
              _xisobRaqamCell = worksheet.getCell("B".concat(row_number));
              _xisobRaqamCell.value = worker.xisob_raqam;
              _accountNumberCell = worksheet.getCell("C".concat(row_number));
              _accountNumberCell.value = worker.account_number;
              _task_timeCell = worksheet.getCell("D".concat(row_number));
              _task_timeCell.value = worker.task_time;
              _summaCell = worksheet.getCell("E".concat(row_number));
              _summaCell.value = worker.summa;
              _deductionCell = worksheet.getCell("F".concat(row_number));
              _deductionCell.value = worker.deduction_money;
              _result_summaCell = worksheet.getCell("G".concat(row_number));
              _result_summaCell.value = worker.result_summa;
              _css_array2 = [_fioCell, _xisobRaqamCell, _accountNumberCell, _task_timeCell, _summaCell, _deductionCell, _result_summaCell];
              itogo_summa += worker.summa;
              itogo_deduction += worker.deduction_money;
              itogo_result += worker.result_summa;
              _css_array2.forEach(function (item, index) {
                var horizontal = 'center';
          ...
          itogo_summaCell = worksheet.getCell("E".concat(row_number));
          itogo_summaCell.value = itogo_summa;
          itogo_deductionCell = worksheet.getCell("F".concat(row_number));
          itogo_deductionCell.value = itogo_deduction;
          itogo_resultCell = worksheet.getCell("G".concat(row_number));
          ...
          return workbook.xlsx.writeFile(filePath);
        case 66:
          return _context11.abrupt("return", res.download(filePath, function (err) {
            if (err) {
              throw new ErrorResponse(err, err.statusCode);
            }
          }));
  ...
  return function exportRasxodByIdExcelData(_x17, _x18) {
...
var forPdfData = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 10:
          ...
          return _context12.abrupt("return", res.success(req.i18n.t('getSuccess'), 200, null, data));
        case 14:
          _context12.prev = 14;
          _context12.t0 = _context12["catch"](0);
          errorCatch(_context12.t0, res);
        case 17:
        case "end":
  ...
  return function forPdfData(_x19, _x20) {
...
module.exports = {
  ...
  exportRasxodByIdExcelData: exportRasxodByIdExcelData,
